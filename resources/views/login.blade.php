...
<body>
    ...
    <!-- about section -->
    <section class="vh-100 p-lg-0" style="background-color: #292525;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 text-black">
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">

                        <form style="width: 23rem;" action="{{ route('validatedata') }}" method="POST"
                            ...
                            <div class="form-outline mb-4">
                                <input type="email" id="form2Example18" name="email" style="border-radius: 0"
                                    placeholder="Enter Email" class="form-control form-control-lg" />
                                <span> @error('email')
                            ...
                            <div class="pt-1 mb-4">
                                <button class="btn btn-warning btn-lg" style="border-radius: 0"
                                    type="submit">Login</button>
                            </div>

                            {{-- <p class="small mb-5 pb-lg-2"><a class="text-muted" href="#!">Forgot password?</a></p> --}}
                            <p class="text-white">Don't have an account? <a href="{{ route('registrationpage') }}"
                                    class="link-info text-warning">Register here</a></p>
